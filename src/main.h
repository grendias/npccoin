...
static const int LAST_POW_BLOCK = 40100; // POW 0 Reward / Block
...
#endif
static const uint256 hashGenesisBlock("0x0000054cf20e224b929ff7e579b9bdf7acf32d2dbab73517e2050b27ac23ebf2");
...
public:
    ...
    {
        // NPC: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // NPC: get transaction coin age
...
public:
    ...
    // NPC: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // NPC: two types of block: proof-of-work or proof-of-stake
    ...
    // NPC: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // NPC: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // NPC: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // NPC: block index flags
    enum
    {
